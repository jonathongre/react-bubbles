...
- [X] Describe how web servers work.
      ...
      `Web servers receive a request from the client, it then retrieves the requested info, either files or fetches database information, then sends a response back to the client with the results as well as headers describing the status code of the request, the type of response data etc.`
